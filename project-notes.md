...
Use [`docs/WINDOWS-TEST-PLAYBOOK.md`](docs/WINDOWS-TEST-PLAYBOOK.md) on `BNDZShell` after `scripts/build-bndz-native.ps1`. Code for E4 sheets / Share dedupe / Open Terminal → ConPTY→xterm / D6 unsigned-beta is landed — remaining work is click-through sign-off.
