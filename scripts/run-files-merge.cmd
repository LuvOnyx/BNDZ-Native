...
setlocal
cd /d "%~dp0.."
REM Prefer unpackaged / build output paths for Files.App
set EXE=
for %%P in (
...
if "%EXE%"=="" (
  echo Files merge exe not found. Run scripts\build-files-bndz-merge.ps1 on Windows first.
  exit /b 1
)
echo Starting BNDZ Files Merge: %EXE%
start "" %EXE%
endlocal
