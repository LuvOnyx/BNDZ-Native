...
public static class BndzBrandingText
{
    public static string Sanitize(string? text)
    {
        ...
        return text
            ...
            .Replace("from Flow Launcher", "from BNDZ Launcher", StringComparison.OrdinalIgnoreCase)
            .Replace("in Flow Launcher", "in BNDZ Launcher", StringComparison.OrdinalIgnoreCase)
            .Replace("via Flow Launcher", "via BNDZ Launcher", StringComparison.OrdinalIgnoreCase)
