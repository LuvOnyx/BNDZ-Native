...
public static class LauncherSystemCommands
{
    ...
    [
        ...
        new() { Id = "system-open-extensions", Title = "Plugins", Subtitle = "Browse installed extensions", Category = "extension", IconGlyph = "🧩", Keywords = ["extension", "extensions", "plugin", "plugins"], Detail = "See installed launcher extensions and their keywords." },
