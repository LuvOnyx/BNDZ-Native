...
/// <summary>
/// Keeps untrusted relative paths (archive entries, Mesh Drop chunks) inside a destination folder.
/// Path.Combine ignores destDir for rooted paths, and ".." segments resolve outside the root (zip-slip).
/// </summary>
