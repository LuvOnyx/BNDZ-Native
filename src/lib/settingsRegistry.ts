...
/** Keys known to be UI-only / placeholders until a real consumer exists. */
const DEFERRED_KEYS = new Set([
  'allowZombiesInTheMiniTree',
  'inNetworkLocationsAsWell',
  'showFolderSizeOnPropertiesTab',
  'keepCurrentItemInViewAfterResorting',
  'scrollToTopAfterResorting',
  'showImplicitSecondarySortOrderArrow',
  'useDialogToRenameSingleItems',
  'includeRemovableDrives',
  'includeVirtualFolders',
  'includeNetworkLocations',
  'refreshDuringFileOperations',
  'cacheSpecificIcons',
  'showIconOverlays',
  'showShortcutOverlays',
  'showSharedFolderOverlays',
  'showCustomFileIcons',
  'showEmbeddedIconsOnPropertiesTab',
  'historyWithoutDuplicates',
  'historyPerTab',
  'historyRetainsSelections',
  'historyRetainsSortOrder',
  'rememberPermanentVariables',
  'customItemsInTheContextMenu',
  'holdCtrlToInvertTheAboveSelection',
  'nativeDragAndDropContextMenu',
  'navigationCommandsInListContextMenu',
  'findFilesCommandsInListContextMenu',
  'holdCtrlToShowCellContextMenu',
  'useLocalizedSearchAndFilterPatterns',
  'pointToSelect',
  'onTheIconOnly',
  'foldersOnly',
  'toTheIconOnly',
  'allowDraggingFromABackgroundWindow',
  'shiftWheelScrollsHorizontally',
  'ctrlWheelScrollsThroughTheListViews',
  'showTooltips',
  'showVerbatimTooltips',
  'tooltipZoom',
  'scrollMargin',
  'wheelScrollLines',
  'showDragStatusBox',
  'deleteOnKeyUp',
  'treatPortableDevicesAsReadOnly',
  'directionalFormattingCodesProtection',
  'assumeThatServersAreAvailable',
  'cacheNetworkServers',
  'assumeThatMappedNetworkDrivesAreAvailable',
  'skipCalculationOfFreeDiskSpaceForMappedNetworkDriv',
  'expandInTree',
  'openCommandLineStartPathInNewTab',
  'openNewInstanceAlways',
  'showSplashScreenWhileLoading',
  'checkForUpdatesAtStartup',
  'includeBetaVersions',
  'checkForLanguageUpdatesAtStartup',
  'noNetworkBrowsingAtStartup',
  'reconnectMappedNetworkDrivesAtStartup',
  'includeMostRecentlyUsedListsOnSave',
  'backupSettingsOnSave',
  'saveChangesToDiskImmediately',
  'extendedCompatibilityForClipboardAndDragAndDrop',
  'toggleTagsByColumnClick',
  'popupByTagColumnsRightClick',
  'applyTaggingToAllSelectedItems',
  'confirmCopyingTags',
  'autoRefreshTags',
  'tagsStorage',
]);
