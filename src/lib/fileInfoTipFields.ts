...
export const EXTRA_FILE_INFO_FIELDS: FileInfoTipField[] = [
  ...
  { id: 'lens', label: 'Lens Model', metadataKey: 'Lens Model', group: 'extra' },
  { id: 'gps', label: 'GPS', metadataKey: 'GPS', group: 'extra' },
  { id: 'title', label: 'Title', metadataKey: 'Title', group: 'extra' },
  { id: 'album', label: 'Album', metadataKey: 'Album', group: 'extra' },
  { id: 'artists', label: 'Artists', metadataKey: 'Artists', group: 'extra' },
  { id: 'genre', label: 'Genre', metadataKey: 'Genre', group: 'extra' },
  { id: 'year', label: 'Year', metadataKey: 'Year', group: 'extra' },
  { id: 'track', label: 'Track', metadataKey: 'Track', group: 'extra' },
