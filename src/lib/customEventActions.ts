...
export const DEFAULT_CUSTOM_EVENT_ACTIONS: CustomEventAction[] = [
  ...
  { id: 'cea-dbl-white-breadcrumb', event: 'double-click-white-breadcrumb', action: 'open-favorites' },
  { id: 'cea-dbl-white-omnibar', event: 'double-click-white-omnibar', action: 'open-favorites' },
...
export const CEA_ACTION_LABELS: Record<CeaAction, string> = {
  ...
  'open-favorites': 'Open Command Hub (places / favorites)',
...
export const CEA_EVENT_GROUPS: { title: string; events: { id: string; label: string }[] }[] = [
  {
    ...
    events: [
      ...
      { id: 'double-click-white-omnibar', label: 'Double-click on white in fuzzy / command bar' },
