...
export const LAUNCHER_ICON_REV = '11';
...
export const TOOLBAR_LAUNCHER_ICONS: Record<string, string> = {
  ...
  zoom_in_ui: 'zoom_in_ui.png',
  zoom_out_ui: 'zoom_out_ui.png',
...
export const UI_GLYPH_IDS = new Set([
  ...
  'film_ui', 'code_ui', 'info_ui', 'help_ui', 'table_ui', 'dashboard_ui', 'category_ui',
  ...
  'globe_ui', 'filter_ui', 'arrow_right_ui', 'monitor_ui', 'cloud_ui', 'git_branch_ui',
