...
export const AVAILABLE_ITEMS: ToolbarItemDef[] = [
  ...
  { id: 'icon_studio', label: 'Icons', color: '#ec4899', category: 'plugins' },
  { id: 'find', label: 'Search', color: '#0ea5e9', category: 'plugins' },
  { id: 'dropstack', label: 'Drop Zone', color: '#8b5cf6', category: 'plugins' },
  { id: 'filters', label: 'Filters', color: '#22d3ee', category: 'plugins' },
  { id: 'batch_rename', label: 'Batch Rename', color: '#fb923c', category: 'plugins' },
  { id: 'shell_menus', label: 'Context Menus', color: '#60a5fa', category: 'plugins' },
  { id: 'metadata', label: 'Metadata', color: '#2dd4bf', category: 'plugins' },
  { id: 'storage_cleanup', label: 'Cleanup', color: '#f87171', category: 'plugins' },
  ...
  { id: 'extension_hub', label: 'Plugins', color: '#0078d4', category: 'plugins' },
  ...
  { id: 'sysdm_cpl', label: 'Properties', color: '#c084fc', category: 'windows' },
