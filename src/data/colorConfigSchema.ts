...
export const COLOR_CONFIG_FIELDS: ColorConfigField[] = [
  ...
  { key: 'colorConfig36', label: 'Name Column Accent', default: '#38bdf8', previewText: '#0f172a', section: 'details' },
  { key: 'colorConfig37', label: 'Type Column Accent', default: '#a78bfa', previewText: '#0f172a', section: 'details' },
  { key: 'colorConfig38', label: 'Size Column Accent', default: '#fbbf24', previewText: '#0f172a', section: 'details' },
  { key: 'colorConfig39', label: 'Modified Column Accent', default: '#2dd4bf', previewText: '#0f172a', section: 'details' },
  { key: 'colorConfig40', label: 'Created Column Accent', default: '#67e8f9', previewText: '#0f172a', section: 'details' },
  { key: 'colorConfig41', label: 'Attributes Column Accent', default: '#94a3b8', previewText: '#0f172a', section: 'details' },
  { key: 'colorConfig42', label: 'Tags Column Accent', default: '#ef4444', previewText: '#0f172a', section: 'details' },
  { key: 'colorConfig43', label: 'Label Column Accent', default: '#c084fc', previewText: '#0f172a', section: 'details' },
  { key: 'colorConfig44', label: 'Comment Column Accent', default: '#fb923c', previewText: '#0f172a', section: 'details' },
  { key: 'colorConfig45', label: 'Path Column Accent', default: '#60a5fa', previewText: '#0f172a', section: 'details' },
